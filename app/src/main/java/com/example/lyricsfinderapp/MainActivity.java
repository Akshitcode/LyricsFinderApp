...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String lyricsurl = "https:rarer-ray.000webhostapp.com/lyrics.json";

        /*StringRequest request = new StringRequest(Request.Method.GET, lyricsurl, new Response.Listener<String>() {
            @Override
